...
export const getProposalLocationCheckEmailForParticipants = (
  validContacts: string[],
  proposal: Proposal,
  proposalUrl: string,
): IEmail => ({
  ...
  categories: [EmailCategory.StatusChange],
  subject: 'Projektantrag an Standorte geleitet',
  text: `Das Projekt "${proposal.projectAbbreviation}" mit Ihrer Beteiligung wurde durch einen FDPG-Mitarbeiter bearbeitet und an die gewünschten Standorte weitergeleitet.`,
});
